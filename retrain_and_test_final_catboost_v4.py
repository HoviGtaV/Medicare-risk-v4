...
test_path  = Path("data/processed/test_v4.parquet")

out_dir = Path("models_v4/final")
...
print("Train v4 shape:", train_df.shape)
print("Valid v4 shape:", valid_df.shape)
print("Test v4 shape:", test_df.shape)
...
print("\n=== FINAL CATBOOST V4 TEST METRICS ===")
...
test_scored["score_catboost_final_v4"] = test_scores
test_scored = test_scored.sort_values("score_catboost_final_v4", ascending=False)
...
pd.DataFrame([metrics]).to_csv("outputs/metrics_v4/final_catboost_v4_metrics.csv", index=False)
...
print("outputs/metrics_v4/final_catboost_v4_metrics.csv")
