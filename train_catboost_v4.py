...
out_dir = Path("models_v4/catboost")
...
print("\n=== CATBOOST V4 VALIDATION METRICS ===")
...
valid_scored["score_catboost_v4"] = valid_scores
valid_scored = valid_scored.sort_values("score_catboost_v4", ascending=False)
...
pd.DataFrame([metrics]).to_csv("outputs/metrics_v4/catboost_v4_metrics.csv", index=False)
...
print("outputs/metrics_v4/catboost_v4_metrics.csv")
