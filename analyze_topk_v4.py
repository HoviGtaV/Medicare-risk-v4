...
df = pd.read_parquet("models_v4/final/test_scored.parquet")
...
summary_df.to_csv("outputs/metrics_v4/topk_summary_v4.csv", index=False)
...
top500_mix.to_csv("outputs/metrics_v4/top500_provider_type_mix_v4.csv", index=False)
...
top1000_mix.to_csv("outputs/metrics_v4/top1000_provider_type_mix_v4.csv", index=False)

print("Top-K summary:")
print(summary_df.to_string(index=False))

print("\nSaved:")
print("outputs/metrics_v4/topk_summary_v4.csv")
print("outputs/metrics_v4/top500_provider_type_mix_v4.csv")
print("outputs/metrics_v4/top1000_provider_type_mix_v4.csv")
